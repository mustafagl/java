...
public static int carx,ilerisensorx,sagsensorx,solsensorx,tespitedilenilerimesafe,tespitedilensagmesafe,tespitedilensolmesafe;
 public static int cary,ilerisensory,sagsensory,solsensory,soncary,reset,sıra=0,maxcary=500;
  	...
  	if(cary==soncary) {
            	...
            	if(reset>100) {
            		...
            		carx=250;
            				...
            				reset=0;
            				 if(sıra%2 == 1){
            					 w[0]+=tespitedilenilerimesafe*sıra/100+tespitedilenilerimesafe/100+wb/100*sıra;
            					 w[1]+=tespitedilensagmesafe*sıra/100+tespitedilensagmesafe/100+wb/100*sıra;
            					 w[2]+=tespitedilensolmesafe*sıra/100+tespitedilensolmesafe/100+wb/100*sıra;
...
for(int i=1;i<101;i++) {
    ...
    public void paint(Graphics g) {
    	...
    	g.setColor(Color.BLACK);
    	 ...
    	 System.out.println(tespitedilenilerimesafe+"  "+tespitedilensagmesafe+"  "+tespitedilensolmesafe+"  "+w[0]+"  "+w[1]+"  "+w[2]+"  "+toplamdeger+"  "+sıra);
